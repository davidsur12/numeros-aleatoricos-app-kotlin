 ...
 * Use the [EditarListaFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class EditarListaFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        inflater.inflate(R.menu.menueditarlista , menu);
    }
